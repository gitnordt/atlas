...
function initTalkToUs()
{
	$('#btnTalkToUs').click(function(e) {
		...
		{
			if ($('#actionbar .filing').hasClass('active')) {
				$('#actionbar #navTalkToUs').hide();
				$('#actionbar .filing').removeClass('active');
			} else {
				$('#actionbar #navTalkToUs').slideDown();
				$('#actionbar .filing').addClass('active');
			}
			return;
		}
		...
		$('#actionbar .filing').mouseleave(function(e) {
	...
	$('#btnLookUp').click(function(e) {
		...
		if (!jQuery.support.cssFloat)
		{
			if ($('#actionbar .lookup').hasClass('active')) {
				$('#actionbar #navLookUp').hide();
				$('#actionbar .lookup').removeClass('active');
			} else {
				$('#actionbar #navLookUp').slideDown();
				$('#actionbar .lookup').addClass('active');
			}
			return;
		}
		...
		// Add a mouseOut event to hide navLookUp
		$('#actionbar .lookup').mouseleave(function(e) {
			$('#actionbar #navLookUp').slideUp('medium', function() {
				$('#actionbar .lookup').removeClass('active');
			});
			$(this).unbind('mouseleave');
		});
